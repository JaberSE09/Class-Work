    ...
    function displayListing(cat) {
        ...
        for (var i = 0; i < car_list.length; i++) {
            if (car_list[i].type == cat | displayAll == true) {
                ...
                body += "<tr class=\'list' id=\'p-" + i + "\'>";
                body += "<td class=\'clm-label'>" + car_list[i].stockid + "</td>";
                body += "<td class=\'clm-label'>" + car_list[i].make + "</td>";
                body += "<td class=\'clm-label'>" + car_list[i].model + "</td>";
                body += "<td class=\'clm-label'>" + car_list[i].year + "</td>";
                body += "<td class=\'clm-label'>" + car_list[i].type + "</td>";
                body += "<td class=\'clm-label'>" + car_list[i].color + "</td>";
                body += "<td class=\'clm-label'>$" + car_list[i].price + "</td>";
                body += "<td class=\'clm-label'>" + car_list[i].mileage + "</td>";
                body += "<td class='clm-label'><button type='button' value=\'" + i + "\' class=\'btn btn-primary add-item\'>Add</button><td>";
                body += "</tr>";
            }
...
//console.log("Cart array is currently: " + cart);
    ...
    function displayCartItems() {
        ...
        $('#item-list').html(elm); // modify the table
    }
    /*****************************/
    /* updateCartItemQty()       */
    /*****************************/
